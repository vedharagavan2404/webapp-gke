...
GCS_BUCKET_NAME = "vedha_bucket"
GCS_IMAGE_NAME = "avengers.jpg"
...
def download_file(file_name, bucket_name):
    """
    Function to download a given file from a GCS bucket
    """
...
def download(filename):
    if request.method == 'GET':
        output = download_file(filename, GCS_BUCKET_NAME)
